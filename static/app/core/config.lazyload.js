            ...
            $ocLazyLoadProvider.config({
                ...
                modules: [
                    ...
                    },
                    {
                        name: 'googlemap',
                        files: [
                            'js!http://maps.google.com/maps/api/js?key=AIzaSyDp7XYz2ih9pePJ40o7vGMOj-gTKcChjVQ', // prefix with `js!`, see https://github.com/ocombe/ocLazyLoad/issues/170
                            '/static/lib/ngmap/build/scripts/ng-map.min.js'
                        ]
                    },
                    {
                        name: 'fullcalendar',
